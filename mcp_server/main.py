...
def customers_all(
    ...
    filter: Optional[EcommerceCustomersFilter] = None,
...
def orders_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[EcommerceOrdersFilter] = None,
    fields: Optional[str] = None,
):
    """
    List Orders
...
@app.get(
    ...
    tags=['order_tracking', 'customer_data_handling'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['product_information_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
